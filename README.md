...
Or use the cdn hosted version of the library by adding the following script tag to the bottom of your html body(before your main script): https://cdn.jsdelivr.net/gh/Austin-Hoyle/hoverable.js@v.90/hoverable.js
